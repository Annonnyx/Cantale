...
export type ShopCategory = "grade" | "lives" | "tool" | "pack";
...
export interface ShopItem {
  ...
  // Ce qui est délivré in-game si la boutique est activée (informatif pour l'instant)
  delivers?: Record<string, number | string>;
}
